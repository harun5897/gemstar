...
function Card () {
  return (
    <div className="ml-[33px] flex flex-wrap">
      <div className="sm:w-[259px] mt-[24px] h-[184px] rounded-[5px] p-[21px] relative sm:mr-[15px] mr-0 drop-shadow-md bg-white">
      ...
      <div className="sm:w-[259px] mt-[24px] h-[184px] rounded-[5px] px-[21px] pt-[10px] relative sm:mr-[15px] mr-0 drop-shadow-md bg-white">
        <img className="absolute right-[10px] top-[6px]" src={ IconDot } alt='' />
      ...
      <div className="sm:w-[259px] mt-[24px] h-[184px] rounded-[5px] px-[21px] pt-[26px] relative sm:mr-[15px] mr-0 drop-shadow-md bg-white">
        <img className="absolute right-[10px] top-[6px]" src={ IconDot } alt='' />
        <img src={ LogoRmi } alt='' />
